...
|---------|-----------|---------|
| **rr_interval_samples** | Intervalo entre batimentos (amostras) | decimal com 16 casas decimais |
...
Desenvolvido como parte do **Bootcamp Santander 2025 - Ciência de Dados com Python** por mim, Shayenne.
